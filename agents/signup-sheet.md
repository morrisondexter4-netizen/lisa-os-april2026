...
Handles teacher meeting/consultation requests. The source document is a Google Doc shared with the Motive Gmail.

## Source
- **Google Doc (source of truth)**: https://docs.google.com/document/d/1z5Da56i3BQfM1QjR5C0y4PzjadWtFBmLwiQ9FLRNspY/edit
  - Shared with lisa@motive-os.com — check directly for new entries
...
2. Also search Gmail (lisa@motive-os.com) for sign-up notifications
...
3. Create Gmail draft in lisa@motive-os.com: reply to teacher confirming the meeting time
